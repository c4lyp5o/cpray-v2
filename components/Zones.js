    ...
    <form onSubmit={handleSubmit}>
      <select id='zone' required='' name='zone'>
        ...
        <optgroup label='Kelantan'>
          <option value='ktn01'>
            JAJAHAN KOTA BHARU, BACHOK, PASIR PUTEH, TUMPAT , PASIR MAS, TANAH
            MERAH, MACHANG KUALA KRAI DAN GUA MUSANG (DAERAH CHIKU)
          </option>
          <option value='ktn03'>
            JAJAHAN JELI, GUA MUSANG (DAERAH GALAS DAN BERTAM) DAN JAJAHAN KECIL
            LOJING
          </option>
        </optgroup>
        ...
        <optgroup label='Perak'>
          ...
          <option value='prk05'>
            TELUK INTAN, BAGAN DATUK, KG. GAJAH, SERI ISKANDAR, BERUAS, PARIT,
            LUMUT, SITIAWAN DAN PULAU PANGKOR
          </option>
          <option value='prk06'>
        ...
        <optgroup label='Sabah'>
          <option value='sbh01'>
            BAHAGIAN SANDAKAN (TIMUR) BANDAR SANDAKAN, BUKIT GARAM, SEMAWANG,
            TEMANGGONG DAN TAMBISAN
          </option>
          <option value='sbh02'>
          ...
          <option value='sbh04'>
            BAHAGIAN TAWAU (BARAT), BANDAR TAWAU, BALONG, MEROTAI DAN KALABAKAN
          </option>
          <option value='sbh05'>
          ...
          <option value='sbh07'>
            BAHAGIAN PANTAI BARAT KOTA KINABALU, PENAMPANG, TUARAN, PAPAR, KOTA
            BELUD, PUTATAN DAN RANAU
          </option>
          <option value='sbh08'>
            BAHAGIAN PEDALAMAN (ATAS) PENSIANGAN, KENINGAU, TAMBUNAN DAN NABAWAN
          </option>
          <option value='sbh09'>
        ...
        <optgroup label='Sarawak'>
          ...
          <option value='swk04'>
            IGAN, KANOWIT, SIBU, DALAT, OYA, BALINGIAN, MUKAH, KAPIT DAN SONG
          </option>
          <option value='swk05'>
            BELAWAI, MATU, DARO, SARIKEI, JULAU, BINTANGOR DAN RAJANG
          </option>
          <option value='swk06'>
            KABONG, LINGGA, SRI AMAN, ENGKELILI, BETONG, SPAOH, PUSA, SARATOK,
            ROBAN, DEBAK DAN LUBOK ANTU
          </option>
          <option value='swk07'>
        ...
        <optgroup label='Selangor'>
          <option value='sgr01'>
            HULU SELANGOR, GOMBAK, PETALING/SHAH ALAM, HULU LANGAT DAN SEPANG
          </option>
